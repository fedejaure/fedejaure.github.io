...
BLOG_AUTHOR = "Federico Jaureguialzo"  # (translatable)
BLOG_TITLE = "Maybe I'm Just Boring"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://fedejaure.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://fedejaure.github.io/"
BLOG_EMAIL = "federico@jaureguialzo.com.ar"
BLOG_DESCRIPTION = "Personal site powered by Nikola."  # (translatable)
